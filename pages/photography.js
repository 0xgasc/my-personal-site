export default function Photography() {
  return (
    <div className="min-h-screen bg-white text-gray-900 font-sans p-8">
      ...
      <p className="">
        i explore light, story, and composition through photography — from street shots to abstract scenes. Here's some of my latest pieces on Zora:
      </p>
  ...
  >
    random collectibles – post 2022
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 max-w-4xl">
          <a href="https://opensea.io/item/ethereum/0x8b7fb2b5aee1f48e354e5e81605864319ec19039/8" target="_blank" rel="noopener noreferrer" className="block rounded overflow-hidden shadow hover:shadow-lg transition-shadow duration-300">
            <img
          ...
          <a href="https://opensea.io/item/zora/0xf604c8204c4ca417635080c45f4ace8d0a7cf3ca/1" target="_blank" rel="noopener noreferrer" className="block rounded overflow-hidden shadow hover:shadow-lg transition-shadow duration-300">
            <img
          ...
          <a href="https://opensea.io/item/zora/0x2e3112987df0b0beb942203701abc0efb6c572d0/21" target="_blank" rel="noopener noreferrer" className="block rounded overflow-hidden shadow hover:shadow-lg transition-shadow duration-300">
            <img
